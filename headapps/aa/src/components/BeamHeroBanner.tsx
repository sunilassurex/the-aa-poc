    ...
    <div className="md:!py-[1.5rem] pt-[1rem]">
      <div className="relative !max-w-[192rem] md:!mx-auto">
        <div className="overflow-hidden md:mt-[-15px] mt-[-10px] !p-[0px] mx-[0px] mb-[0px]">
          ...
          >
            <div className="!px-[16px] table md:max-w-[116rem] md:!mx-auto flex flex-wrap items-center z-[1] h-full flex-1 md:px-[40px] md:pl-[27px]">
              <div className="md:max-w-[636px] align-middle table-cell max-w-none">
                <h1 className="font-newtransport !font-bold !text-[28px] !leading-[32px] !mb-[16px] text-center md:!text-[64px] md:!leading-[72px] !tracking-[0px] text-[#1d1d1d] md:mb-[24px] !normal-case">
